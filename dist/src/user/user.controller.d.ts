...
export declare class UserController {
    ...
    findAll(): Promise<import("../utility/response.utill").ResponseData<import("./entities/user.entity").User[]>>;
    findOne(id: string): Promise<import("../utility/response.utill").ResponseData<import("./entities/user.entity").User>>;
